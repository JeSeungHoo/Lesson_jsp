<%@page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.util.*, util.*, vo.*, java.sql.*"%>
...
javax.sql.DataSource ds = (javax.sql.DataSource) init.lookup("java:comp/env/java/MySqlDB");
