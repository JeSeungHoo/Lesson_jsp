...
<table>
	...
	<tr>
		...
		<td>
			<label>
				<input type="radio" name="gender" value="남성" <%=loginMember.getGender().equals("남성") ? "checked" : "disabled"%> />
				남성
			</label>
			<label>
				<input type="radio" name="gender" value="여성" <%=loginMember.getGender().equals("여성") ? "checked" : "disabled"%> />
				여성
			</label>
		</td>
	</tr>
